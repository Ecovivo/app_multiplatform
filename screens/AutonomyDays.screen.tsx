import type { AutonomyDaysProps } from "../models";

import { useState } from "react";
import { SvgXml } from "react-native-svg";
import { Text, ScrollView, StyleSheet, View } from "react-native";

import { Color, trees, autonomyDays, Options } from "../values";
import { Next, Radio } from "../components";

const { label, description, options } = autonomyDays;
const AutonomyDays: AutonomyDaysProps = ({ handlePress }) => {
